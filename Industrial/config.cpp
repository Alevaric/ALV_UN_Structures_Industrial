...
class CfgVehicles
{
	...
	class Land_Red_Barn: HouseNoDestruct
	{
		scope=1;
	...
	class Land_Workshop_Medium: HouseNoDestruct
	{
		scope=1;
	...
	class Land_Stable_Store: HouseNoDestruct
	{
		scope=1;
	...
	class Land_Wood_Workshop: HouseNoDestruct
	{
		scope=1;
	...
	class Land_Blacksmiths: HouseNoDestruct
	{
		scope=1;
	...
	class Land_Wooden_Stable: HouseNoDestruct
	{
		scope=1;
	...
	class Land_StorageHouse: HouseNoDestruct
	{
		scope=1;
		model="ALV_UN_Structures_Industrial\Industrial\House_StorageHouse.p3d";
	};
	class Land_Storehouse_1: HouseNoDestruct
	{
		scope=1;
	...
	class Land_ShoeHorseBarn: HouseNoDestruct
	{
		scope=1;
	...
	class Land_PigShed: HouseNoDestruct
	{
		scope=1;
	...
	class Land_PigShed_2: HouseNoDestruct
	{
		scope=1;
	...
	class Land_MediumBarn: HouseNoDestruct
	{
		scope=1;
	...
	class Land_LargeBarn: HouseNoDestruct
	{
		scope=1;
	...
	class Land_Small_Construction: HouseNoDestruct
	{
		scope=1;
	...
	class Land_Medium_Construction: HouseNoDestruct
	{
		scope=1;
